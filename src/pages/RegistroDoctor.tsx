...
export function RegistroDoctor() {
  ...
  const handleRegister = async () => {
    try {
      ...
      alert('Doctor registrado exitosamente. Ahora puede iniciar sesión.');
      history.push('/login');
    } catch (err) {
      alert('Error al registrar doctor. Intenta con otro correo.');
    }
  };
  ...
  return (
    <IonPage>
      <IonContent className="ion-padding">
        ...
        <IonButton expand="block" onClick={handleRegister}>Registrar Doctor</IonButton>
      </IonContent>
    </IonPage>
  );
}
...
import { TasksContextType } from "./TasksContext.type";
...
export const TasksContext = createContext<TasksContextType.Context>({
  totalTasks: 0,
...
export function TasksProvider(props: TasksContextType.Props) {
  ...
  const valueContext: TasksContextType.Context = {
    totalTasks,
    totalTasksCompleted,
    tasks,
    completedTasks,
